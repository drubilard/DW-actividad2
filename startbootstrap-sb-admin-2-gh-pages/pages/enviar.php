...
?>
  ...
  <div class="panel panel-default">
    ...
    <div class="panel-body">
      ...
      <p>Tu correo electrónico es <b><?php echo $correo; ?></b>, y tu contraseña tiene <b><?php echo strlen($contrasena); ?></b> caracteres. y su rut es <?php echo $rut; ?></p>
      <p>
      ...
      <p>
         Tu sexo es: <b><?php if($sexo == 'm'){
                            echo 'masculino';
                             }elseif ($sexo =='f' ) { echo 'femenino';}else echo 'No Responde';?>
     </p>
      <p>
        Tu <b><?php echo ($terminos == 1 ? 'sí' : 'no'); ?></b> aceptaste los términos y condiciones. y <?php echo ($terminos2 == 1 ? 'sí': 'no'); ?>  aceptaste recivir correos no deseados
      </p>
    </div>
